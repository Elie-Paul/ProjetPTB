...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CommandeVignetteRepository")
 */
class CommandeVignette
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Vignette", inversedBy="commandeVignettes")
