 ...
 */
final class Version20190409105539 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(150) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(12) NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL, nombre_carte INT DEFAULT NULL, expiration DATETIME DEFAULT NULL, INDEX IDX_351268BBC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
