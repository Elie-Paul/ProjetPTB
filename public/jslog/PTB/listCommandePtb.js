...
function getAllCommande()
{
    ...
    xhr.open("GET",superLink+"/Json/listCommande",false);
    xhr.send();
...
function modifierCommande(element)
{
    ...
    .then((value) => 
    {
        ...
        xhr.open("GET",`${superLink}/commande/ptb/modifier/${id}/${value}`,true);
        xhr.send();
        getAllCommande();
        updateTab();
    });
...
function deleteCommande(element)
{
    ...
    .then((willDelete) => 
    {
        if(willDelete)
        {
            ...
            xhr.open("GET",`${superLink}/commande/ptb/delete/${id}`,true);
            xhr.send();
            getAllCommande();
            updateTab();
        }    
